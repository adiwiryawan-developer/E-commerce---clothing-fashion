                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product__details__text">
                                ...
                                <div class="product__details__price">Rp. <?php echo $row['price'] * 0.9 ?> <span>Rp. <?php echo $row['price'] ?></span></div>
                                ...
                                <div class="product__details__widget">
                                    ...
                                    <div class="color__checkbox">
                                        ...
                                        <li>
                                            ...
                                            <p>Order over Rp. 10000 Free Delivery </p>
                                        </li>
                                        <li>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                ...
                                <div class="product__price">Rp. <?php echo $row_rel['price'] ?></div>
                            </div>
                        </div>
                    </div>
                <?php
