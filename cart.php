                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="cart__price">Rp. <?php echo $pro_row['price'] ?></td>
                                            <td class="cart__quantity">
                                                <div class="pro-qty">
                                                    <input type="text" value="<?php echo $row['pro_quantity'] ?>">
                                                </div>
                                            </td>
                                            <td class="cart__total">Rp. <?php echo ($sub_total = ($pro_row['price']) * ($row['pro_quantity']))?></td>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-2">
                    <div class="cart__total__procced">
                        <h6>Cart total</h6>
                        <ul>
                            <!-- <li>Subtotal <span>Rp. <?php echo $total ?></span></li> -->
