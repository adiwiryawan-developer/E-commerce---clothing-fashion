                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mix t_shirts">
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                ...
                                <div class="product__price">Rp. <?php echo $row['price'] ?></div>
                            </div>
                        </div>
                    </div>
                    <?php
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mix shirts">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <div class="product__price">Rp. <?php echo $row1['price'] ?></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mix trousers">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <div class="product__price">Rp. <?php echo $row2['price'] ?></div>
                                    </div>
                                </div>
                            </div>
                <?php
                    ...
                    <div class="trend__content">
                        ...
                        <div class="trend__item">
                            ...
                            <div class="trend__item__text">
                                ...
                                <div class="product__price">Rp. 600</div>
                            </div>
                        </div>
                        <div class="trend__item">
                            <div class="trend__item__pic">
                            ...
                            <div class="trend__item__text">
                                ...
                                <div class="product__price">Rp. 3000</div>
                            </div>
                        </div>
                        <div class="trend__item">
                            <div class="trend__item__pic">
                            ...
                            <div class="trend__item__text">
                                ...
                                <div class="product__price">Rp. 1500</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="trend__content">
                        ...
                        <div class="trend__item">
                            ...
                            <div class="trend__item__text">
                                ...
                                <div class="product__price">Rp. 4000</div>
                            </div>
                        </div>
                        <div class="trend__item">
                            <div class="trend__item__pic">
                            ...
                            <div class="trend__item__text">
                                ...
                                <div class="product__price">Rp. 6000</div>
                            </div>
                        </div>
                        <div class="trend__item">
                            <div class="trend__item__pic">
                            ...
                            <div class="trend__item__text">
                                ...
                                <div class="product__price">Rp. 2000</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="trend__content">
                        ...
                        <div class="trend__item">
                            ...
                            <div class="trend__item__text">
                                ...
                                <div class="product__price">Rp. 3300</div>
                            </div>
                        </div>
                        <div class="trend__item">
                            <div class="trend__item__pic">
                            ...
                            <div class="trend__item__text">
                                ...
                                <div class="product__price">Rp. 2300</div>
                            </div>
                        </div>
                        <div class="trend__item">
                            <div class="trend__item__pic">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="services__item">
                        <i class="fa fa-car"></i>
                        <h6>Free Shipping</h6>
                        <p>For all oder over Rp. 10,000</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="services__item">
