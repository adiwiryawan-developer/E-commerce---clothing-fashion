...
<body>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Multi Columns Form -->
                                <form class="row g-3  needs-validation" action="delete_product_3.php" enctype="multipart/form-data" method="post" novalidate>

                                    <input type="hidden" name="pro_id" value="<?php echo $row['pro_id'] ?>">

                                    <div class="col-md-12">
                                        <label for="inputName5" class="form-label">Product Name</label>
                                        <input type="text" name="pro_name" value="<?php echo $row['pro_name'] ?>" class="form-control" id="inputName5" required disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputState" class="form-label">Category</label>
                                        <select id="inputState" name="category" class="form-select" disabled>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="inputState" name="size" class="form-select" disabled>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="brand" value="<?php echo $row['brand'] ?>" class="form-control" id="inputName" required disabled>
                                    </div>
                                    <div class="col-md-6 position: relative">
                                        <label for="validationTooltip03" class="form-label">Price</label>
                                        <input type="number" name="price" value="<?php echo $row['price'] ?>" class="form-control" id="validationTooltip03" required disabled>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">Describtion</label>
                                        <textarea class="form-control" name="description" style="height: 200px" disabled><?php echo $row['description'] ?></textarea>
                                    </div>

                                    <div class="text-center">
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#basicModal">Delete Product</button>
                                    </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" id="btnYes" class="btn btn-danger">Yes</button>
                                                </div>
                                            </div>
                                        </div>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>ADEGDISINI</span></strong>. All Rights Reserved
        </div>
    </footer><!-- End Footer -->
