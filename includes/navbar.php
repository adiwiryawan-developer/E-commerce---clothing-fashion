    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="./home.php"><img src="img/growth1.jpeg" alt=""></a>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            <li <?php if ($_SERVER['SCRIPT_NAME'] == "home.php") {
                                    echo 'class="active"';
                                } ?>><a href="./home.php">Home</a></li>
                            <li <?php if ($_SERVER['SCRIPT_NAME'] == "gallery.php") {
                                    echo 'class="active"';
                                } ?>><a href="./gallery.php">Gallery</a></li>
                            <li <?php if ($_SERVER['SCRIPT_NAME'] == "about_us.php") {
                                    echo 'class="active"';
                                } ?>><a href="./about_us.php">About Us</a></li>
                            <li <?php if ($_SERVER['SCRIPT_NAME'] == "contact_us.php") {
                                    echo 'class="active"';
                            ...
                            ?>
                                <li <?php if ($_SERVER['SCRIPT_NAME'] == "account.php") {
                                        echo 'class="active"';
                                    } ?>><a href="#">Account</a>
                                    <ul class="dropdown">
